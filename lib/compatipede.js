"use strict";
/**
compatipede.js calls githubDispatcher to import issues and URLs
from GitHub and launches serialExecutor to create and run jobs.
*/
...
module.exports = function(argv) {
  ...
  jobModel = new JobModel(dbSettings, argv.jobsDb, saveResources);
